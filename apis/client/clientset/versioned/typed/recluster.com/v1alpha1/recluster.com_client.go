...
type ReclusterV1alpha1Client struct {
	restClient rest.Interface
}
...
// NewForConfigAndClient creates a new ReclusterV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ReclusterV1alpha1Client, error) {
	...
	return &ReclusterV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ReclusterV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *ReclusterV1alpha1Client {
...
// New creates a new ReclusterV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *ReclusterV1alpha1Client {
...
func (c *ReclusterV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
