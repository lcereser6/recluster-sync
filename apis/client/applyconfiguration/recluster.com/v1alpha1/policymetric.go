...
// apply.
func PolicyMetric() *PolicyMetricApplyConfiguration {
	return &PolicyMetricApplyConfiguration{}
}

// WithKey sets the Key field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the Key field is set to the value of the last call.
func (b *PolicyMetricApplyConfiguration) WithKey(value string) *PolicyMetricApplyConfiguration {
	b.Key = &value
	return b
}
...
func (b *PolicyMetricApplyConfiguration) WithTransform(value string) *PolicyMetricApplyConfiguration {
	b.Transform = &value
	return b
}
